...
- **Qué descartamos:**
  - Un slice "el usuario cambia de idioma en la interfaz" que la IA agregó de oficio. No es un slice del CU de búsqueda: si aparece como requerimiento, es un RF/atributo de calidad transversal, no una variante del flujo.
